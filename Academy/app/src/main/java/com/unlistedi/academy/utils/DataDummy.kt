package com.unlistedi.academy.utils
    ...
    companion object {
        ...
        fun generateDummyCourses() : ArrayList<CourseEntity>{
            ...
            courses.add(CourseEntity("a14",
                ...
                "100 Hari",
                null,"https://www.dicoding.com/images/small/academy/menjadi_android_developer_expert_logo_070119140352.jpg"
            ))
        ...
        fun getCourses(courseId: String) : CourseEntity? {
        ...
        fun generateDummyModules(courseId : String) : ArrayList<ModuleEntity>{
            ...
            modules.add(ModuleEntity(String.format("%sm1", courseId),
                courseId,
                "Modul 0 : Introduction",
                0,
                null))
            modules.add(ModuleEntity(String.format("%sm2", courseId),
                courseId,
                "Modul 1 : Teori 1",
                1,
                null))
            modules.add(ModuleEntity(String.format("%sm3", courseId),
                courseId,
                "Latihan 1",
                2,
                null))
            modules.add(ModuleEntity(String.format("%sm4", courseId),
                courseId,
                "Bedah Kode 1",
                3,
                null))
            modules.add(ModuleEntity(String.format("%sm5", courseId),
                courseId,
                "Modul 2 : Teori 2",
                4,
                null))
            modules.add(ModuleEntity(String.format("%sm6", courseId),
                courseId,
                "Latihan 2",
                5,
                null))
            modules.add(ModuleEntity(String.format("%sm7", courseId),
                courseId,
                "Bedah Kode 2",
                6,
                null))
